...
This is the Week 1–2 playable core for **Asteroids gone rogue**. Branch: `0.35-medals-swarm` (do not merge into older version tags; do not rewrite `0.341-scout-drone-polish`; no 0.36; no tag/Release yet).
...
- Top-right badge reads **WORLD 1** on wave 1. After 5 clears it becomes **WORLD 2**, then 3–6, then loops. Arena-swap flashes **WORLD N ONLINE** and plays `maximize_008` (not the hangar purchase cue). First World 2 entry (wave 6) is a short **★ Deep Orbit** beat; the medal persists in the hangar badge row.
...
- Wave clear / fail show a short **Run summary** card: score / wave / world / credits (+ awarded) / upgrades. New record appends **NEW BEST**. After waves 1–3, one short continue line (World 2 / Gunner at 4 / **Buy X before Gunner**). Wave 3 awards **★ Scout Wing** (World 2 at wave 6) and writes it to hangar persist / the badge row — no text wall.
...
- Wave 1: `Enemy_01` v8 Mid mesh. Later: Scout v5 / Gunner v5 / Drone v4. Waves 7+: Bomber v6 / Sniper / SwarmPod v6 if those FBX imported. After wave 10: +1 large asteroid per wave (cap 10).
