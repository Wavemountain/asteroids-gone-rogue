...
namespace AsteroidsGoneRogue
{
    ...
    public static class Loc
    {
        ...
        private static readonly Dictionary<string, string> Swedish = new Dictionary<string, string>
        {
            ...
            { "ui.slot_utility", "UTILITY" },
            { "ui.loadout_slots", "P {0}  ·  U {1}" },
            ...
            { "shop.desc.SpreadBolt", "Primary: 3 bärnstenshagel. LB / Q cyklar. Skilt från cyan pierce." },
            { "shop.title.Pierce", "Pierce" },
            { "shop.desc.Pierce", "Primary: bulten går genom mål. LB / Q cyklar." },
            { "shop.title.TwinGuns", "Tvillingkanoner" },
            { "shop.desc.TwinGuns", "Primary: två parallella fullskada-bultar. Inte en spridsol." },
            { "shop.title.Seeker", "Sökare" },
            { "shop.desc.Seeker", "Utility: magenta-robot. Håll LT / E. Egen cooldown. Svagare styrning, långsammare takt, lägre skada." },
            { "shop.title.Ricochet", "Rikoschett" },
            { "shop.desc.Ricochet", "Utility: limebult, 2 studsar på arenakanten. Håll LT / E. Egen cooldown." },
            ...
            { "shop.title.Rail", "Räl" },
            { "shop.desc.Rail", "Lans-mitt. Primary: håll RT 0.55s, släpp. Skada ×3, fart ×1.2, ingen pierce. CD ×1.6. Miss eller avbryt ger halv cooldown." },
            ...
            { "shop.desc.SeekerCadence", "Jägare-mitt. Utility-cooldown ×0.75. Sökare svänger 165. Mjuklåser andra vägar." },
            { "shop.title.TwinSeek", "Tvilling-sök" },
            { "shop.desc.TwinSeek", "Jägare-topp. Håll LT för 2 sökare på 70% skada. Utility-cooldown ×1.2." },
            ...
            { "ui.hint_dual", "LT utility · LB cykla primary · RT skjut" },
            ...
            { "run.hold_lt", "Håll LT för utility" },
            { "run.buy", "Köp {0}" },
